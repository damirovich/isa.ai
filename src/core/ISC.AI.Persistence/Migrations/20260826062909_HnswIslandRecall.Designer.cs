...
namespace ISC.AI.Persistence.Migrations
{
    ...
    [Migration("20260826062909_HnswIslandRecall")]
    partial class HnswIslandRecall
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ISC.AI.Persistence.Entities.ChunkEntity", b =>
                {
                    ...
                    b.HasIndex("DocumentId", "IsCurrent")
                        .HasDatabaseName("ix_chunk_document_id_is_current");
            ...
            modelBuilder.Entity("ISC.AI.Persistence.Entities.DocumentEntity", b =>
                {
                    ...
                    b.HasIndex("DocDate")
                        .HasDatabaseName("ix_document_doc_date");

                    b.HasIndex("DocType")
                        .HasDatabaseName("ix_document_doc_type");
