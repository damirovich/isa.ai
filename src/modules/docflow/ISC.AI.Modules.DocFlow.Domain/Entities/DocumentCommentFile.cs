...
/// <summary>Файл, прикреплённый к комментарию (ТЗ СКИД §4.8).</summary>
public class DocumentCommentFile : AuditableEntity
{
    /// <summary>Комментарий (FK внутри схемы).</summary>
    public int CommentId { get; set; }

    /// <summary>Навигация к комментарию (запись файла до присвоения идентификатора комментария).</summary>
